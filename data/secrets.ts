...
export const secretDossiers: SecretDossier[] = [
  ...
  },
  {
    ...
    description: "Acoustic analysis suggests the ubiquitous vuvuzela drone was not merely a cultural phenomenon. Classified sound engineering reports indicate the 127dB continuous hum was deliberately amplified at certain stadiums to disrupt team communications. South African security services deny involvement but the sonic signatures match known LRAD devices tested by private military contractors in 2008. Spectrograms of match-day recordings show frequency modulation patterns inconsistent with organic crowd noise—suggesting a centralized amplification system was embedded in at least three host stadiums without public knowledge.",
    classification: "TOP SECRET",
    mediaType: "youtube",
  ...
  },
  {
    ...
    description: "An off-grid recording device captured the Germany dressing room at halftime of the 7-1 semifinal against Brazil. The audio reveals then-assistant coach Hansi Flick producing a notepad with detailed second-half tactical adjustments that exploited Brazil's psychological collapse after Neymar's injury. The final 7-1 scoreline was no accident—it was surgical. The recording, hidden in a fire extinguisher casing by a stadium electrician, captures Flick's chillingly precise instructions: overload the right flank where Marcelo was isolated, press Sergio Ramos high, and target Fernandinho's positioning after the 60th minute when his fitness dropped.",
    classification: "CLASSIFIED",
    mediaType: "gallery",
